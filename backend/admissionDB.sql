...
CREATE TABLE `news` (
    ...
    `news_picture` varchar(255) default "images\\catnews.jpg",
...
insert into news_category(category_no, category_name, news_id) values (2, 'แมว', 1);
...
insert into news_category(category_no, category_name, news_id) values (3, 'กะเพราไก่', 2);
insert into news_category(category_no, category_name, news_id) values (4, 'ผู้ร้ายคลั่ง', 2);
