<template>
  <div
    style="background-color: #dbf6e9; min-height: calc(100vh - 3.25rem)"
    class="p-3"
  >
      ...
      <div class="column is-half">
        <div class="field">
          <label class="label is-size-4"
            >NEWS TITLE <span style="color: red">*</span></label
          >
        ...
        <div class="field">
          <label class="label is-size-4"
            >NEWS DESCRIPTION <span style="color: red">*</span></label
          >
        ...
        <div class="field">
          ...
          <div
            class="columns"
            v-for="item_c in inputs_CATEGORYS"
            :key="item_c.id"
          >
        ...
        <div class="field">
          ...
          <div
            class="columns"
            v-for="item_r in inputs_REFERENCES"
            :key="item_r.id"
          >
            <div class="column is-11">
...
export default {
  ...
  methods: {
    addnews() {
      ...
      axios
        .post(`http://localhost:5000/addnews`, formData, {
